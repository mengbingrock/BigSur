  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-3">
        <h3 className="font-serif text-xl leading-snug tracking-tight text-ink">{skill.name}</h3>
        <div className="flex shrink-0 items-center gap-2 font-mono text-[10px] uppercase tracking-wider">
          {skill.artifactKind === "protocol" && (
            <span className="border border-ink px-1.5 py-0.5 text-ink">Protocol</span>
          )}
